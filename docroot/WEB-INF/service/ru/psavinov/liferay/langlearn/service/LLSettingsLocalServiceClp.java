 ...
 */
public class LLSettingsLocalServiceClp implements LLSettingsLocalService {
	public LLSettingsLocalServiceClp(
	...
	public ru.psavinov.liferay.langlearn.model.LLSettings addLLSettings(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(llSettings) });
		}
		catch (Throwable t) {
		...
		return (ru.psavinov.liferay.langlearn.model.LLSettings)ClpSerializer.translateOutput(returnObj);
	}
	...
	public ru.psavinov.liferay.langlearn.model.LLSettings createLLSettings(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { settingsId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public ru.psavinov.liferay.langlearn.model.LLSettings deleteLLSettings(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { settingsId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public ru.psavinov.liferay.langlearn.model.LLSettings fetchLLSettings(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { settingsId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public ru.psavinov.liferay.langlearn.model.LLSettings getLLSettings(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { settingsId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<ru.psavinov.liferay.langlearn.model.LLSettings> getLLSettingses(
		...
		return (java.util.List<ru.psavinov.liferay.langlearn.model.LLSettings>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public ru.psavinov.liferay.langlearn.model.LLSettings updateLLSettings(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(llSettings), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public ru.psavinov.liferay.langlearn.model.LLSettings findByUserId(
		...
		try {
			...
			if (t instanceof ru.psavinov.liferay.langlearn.NoSuchLLSettingsException) {
				throw (ru.psavinov.liferay.langlearn.NoSuchLLSettingsException)t;
			}
